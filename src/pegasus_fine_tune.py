...
'''
def prepare_fine_tuning(model_name, tokenizer, train_dataset, val_dataset=None, freeze_encoder=False, output_dir='./dataset/EUR-Lex/pegasus-test'):
  """
...
def Pegasus_fine_tune(dir,model_save,model_check):
    ...
    trainer = prepare_fine_tuning(model_name, tokenizer, train_dataset, val_dataset=valid_dataset,output_dir=model_check)
