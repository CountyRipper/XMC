...
if __name__ == '__main__':
    ...
    if models['pega']:
        ...
        for i in range(0):
            ...
            get_combine_bi_list(datadir[da],gener+tasks[i]+"_pred.txt","all_stemlabels.txt",gener+tasks[i]+"_combine_labels.txt")
        #rank_train_BI(datadir[da],tasks[1]+"_texts.txt",gener+tasks[1]+"_combine_labels_bi.txt",tasks[1]+"_labels_stem.txt","bi_en")
        #rank_bi(datadir[da],tasks[0]+"_texts.txt",gener+tasks[0]+"_combine_labels_bi.txt","bi_en",gener+tasks[0]+"_ranked_labels_bi.txt")
        res = p_at_k(datadir[da],tasks[0]+"_labels_stem.txt",tasks[0]+"_combine_labels1.txt",datadir[da]+"res_pega.txt")
        #res = p_at_k(datadir[da],tasks[0]+"_labels_stem.txt",gener+tasks[0]+"_ranked_labels_bi.txt",datadir[da]+"res_pega.txt")
    if models['bart']:
