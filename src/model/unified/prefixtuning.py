...
class PrefixModel(PushToHubFriendlyModel):
    def __init__(self, args):
        ...
        self.mid_dim = args.prefix_mid_dim
        ...
        if self.args.model_knowledge_usage == 'separate':
        ...
        if self.args.model_freeze_plm:
            for param in self.pretrain_model.parameters():
                param.requires_grad = False
        if self.args.model_freeze_prefix:
    ...
    def get_description_representation(self, kwargs):
        if self.args.model_use_description and self.args.model_map_description:
            description_input_ids = kwargs.pop("description_input_ids")
            description_attention_mask = kwargs.pop("description_attention_mask")
            if self.args.bert_location in ["t5-small", "t5-base", "t5-large", "t5-3b", "t5-11b"]:
            ...
            elif self.args.bert_location in ["facebook/bart-base", "facebook/bart-large"]:
    ...
    def get_knowledge_representation(self, kwargs):
        if self.args.model_knowledge_usage == 'separate':
            ...
            if self.args.bert_location in ["t5-small", "t5-base", "t5-large", "t5-3b", "t5-11b"]:
                ...
                raise ValueError()
        elif self.args.model_knowledge_usage == 'concatenate':
            knowledge = None
        else:
            raise ValueError()
